...
public class SuffixArray {
	  ...
	  public static int[] suffixArray(final CharSequence S) {
	    int n = S.length();
	...
	// longest common prefixes array in O(n)
	  ...
	  // sort rotations of S in O(n*log(n)) ....for testing purpose
	  public static int[] rotationArray(final CharSequence S) {
	    int n = S.length();
	    Integer[] order = new Integer[n];
	    for (int i = 0; i < n; i++)
	      order[i] = i;
